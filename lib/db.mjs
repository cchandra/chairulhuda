...
// Keep existing publications navigable when the editorial taxonomy evolves.
db.prepare("UPDATE materials SET topic='Tindak Pidana' WHERE topic='Dasar Hukum Pidana'").run();
db.prepare("UPDATE materials SET topic='Sistem Peradilan Pidana' WHERE topic='Hukum Acara Pidana'").run();
export const topics = ['Tindak Pidana','Kesalahan','Pertanggungjawaban Pidana','Penyertaan','Pidana Korporasi','Sistem Peradilan Pidana','Putusan & Pembuktian','Pemidanaan'];
